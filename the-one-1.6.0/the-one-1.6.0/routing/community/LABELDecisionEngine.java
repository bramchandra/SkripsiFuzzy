...
public class LABELDecisionEngine
    ...
    /**
     * Initializes the decision engine using the given Settings object,
     * extracting the class of community detection algorithm to use. This
     * constructor does NOT create instances of the member fields since this
     * constructor is generally only used to create a "prototype" object that
     * each actual instance replicates.
     *
    ...
    /**
     * Starts timing the duration of the new connection and informs the
     * community detection object of the new connection.
     */
    ...
    /**
     * LABEL Routing works such that we only send the message to hosts in the
     * same local community as the message's destination.
     */
