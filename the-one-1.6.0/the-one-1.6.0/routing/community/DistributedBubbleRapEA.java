 ...
 *
 */
public class DistributedBubbleRapEA
     ...
     */
    public DistributedBubbleRapEA(Settings s) {
     ...
     * object
     */
    public DistributedBubbleRapEA(DistributedBubbleRapEA proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        DistributedBubbleRapEA de = this.getOtherDecisionEngine(peer);
...
//        double time = startTimestamps.get(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        DistributedBubbleRapEA de = getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        DistributedBubbleRapEA de = this.getOtherDecisionEngine(otherHost);
        return de.commumesWithHost(m.getTo())
                && !this.commumesWithHost(m.getTo());
    }

    public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld) {
        DistributedBubbleRapEA de = this.getOtherDecisionEngine(hostReportingOld);
        return de.commumesWithHost(m.getTo())
                && !this.commumesWithHost(m.getTo());
    }

    public RoutingDecisionEngine replicate() {
        return new DistributedBubbleRapEA(this);
    }
    ...
    private DistributedBubbleRapEA getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (DistributedBubbleRapEA) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
