 ...
 * {@link #update()}).
 */
public abstract class ActiveRouterEdit extends MessageRouter {
	 ...
	 */
	public ActiveRouterEdit(Settings s) {
		super(s);
	 ...
	 */
	protected ActiveRouterEdit(ActiveRouterEdit r) {
		super(r);
	...
	public boolean hasEnergy() {
		return this.energy == null || this.energy.getEnergy() > 1;
	}
