...
public interface RoutingDecisionEngine {
    ...
    /**
     * Allows the decision engine to gather information from the given message
     * and determine if it should be forwarded on or discarded. This method is
     * only called when a message originates at the current host (not when
     * received from a peer). In this way, applications can use a Message to
     * communicate information to this routing layer.
     *
    ...
    /**
     * Determines if the given host is an intended recipient of the given
     * Message. This method is expected to be called when a new Message is
     * received at a given router.
     *
     ...
     * host. This method will often be called multiple times in succession as
     * the DecisionEngineRouter loops through its respective Message or
     ...
     * peer and the return code indicates the message is old or already
     * delivered, in which case it might be appropriate to delete the message.
     *
     * @param m Old Message
